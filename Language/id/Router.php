...
return [
    ...
    'invalidDynamicController' => 'Terkait keamanan pengontrol dinamis tidak dizinkan. Rute penanganan: "{0}"',
    'invalidControllerName'    => 'Sebuah pembatas namespace adalah backslash (\\), bukan slash (/). Rute penanganan: "{0}"',
];
